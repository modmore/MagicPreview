 ...
 *
 * Call it uncached, as above: an uncached call is evaluated on every page render,
 * so an extra that caches rendered output cannot store the attributes.
 *
 ...
 *
 * Returns an empty string unless this is a preview shown in the editor's
 * preview panel with magicpreview.click_to_field enabled, so it is inert on
 * live pages, public share links and full-page previews.
 *
 * @var modX $modx
