...
$_lang['setting_magicpreview.click_to_field_desc'] = 'Experimental. When enabled, clicking a field in the preview scrolls the resource form to that field and highlights it. ContentBlocks fields are marked automatically. Core resource fields and TVs must be marked in your template with the mpField snippet, for example: [[mpField? &name=`pagetitle`]] inside the element that renders the field. Changed in 1.8.0: core fields and TVs used to be marked automatically, so after upgrading they stay unmarked until you add mpField. See the readme for ContentBlocks and Fenom examples. Default: No.';
