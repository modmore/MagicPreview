...
$_lang['setting_magicpreview.click_to_field_desc'] = 'When enabled, clicking a field in the preview panel scrolls the resource form to that field. Requires ContentBlocks or a template that adds data-magicpreview-field attributes. Default: Yes.';
