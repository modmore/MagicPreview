...
$_lang['setting_magicpreview.click_to_field'] = 'Click to Field';
$_lang['setting_magicpreview.click_to_field_desc'] = 'Experimental. When enabled, clicking a field in the preview panel scrolls the resource form to that field and highlights it. Previews opened in a new window show no click targets. ContentBlocks fields are marked automatically. Core resource fields and TVs must be marked in your template with the mpField snippet, for example: [[!mpField? &name=`pagetitle`]] inside the element that renders the field. Up to version 1.7, core fields and TVs were marked automatically, so after upgrading they stay unmarked until you add mpField. See the readme for ContentBlocks and Fenom examples. Default: No.';
