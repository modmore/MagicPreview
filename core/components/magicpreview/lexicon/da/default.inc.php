...
$_lang['setting_magicpreview.click_to_field_desc'] = 'Eksperimentel. Når aktiveret, ruller et klik på et felt i forhåndsvisningen ressourceformularen til det pågældende felt og fremhæver det. Fungerer bedst med ContentBlocks, som automatisk omslutter hvert felts output. Der gøres desuden et best-effort-forsøg på at omslultte Core-ressourcefelter (pagetitle, longtitle, description, menutitle, introtext) og TVer via parseren, men dette dækker muligvis ikke alle template-outputkombinationer. Standard: Nej.';
