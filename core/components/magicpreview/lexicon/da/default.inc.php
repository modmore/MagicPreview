...
$_lang['setting_magicpreview.click_to_field'] = 'Klik til felt';
$_lang['setting_magicpreview.click_to_field_desc'] = 'Eksperimentel. Når aktiveret, ruller et klik på et felt i forhåndsvisningspanelet ressourceformularen til det pågældende felt og fremhæver det. Forhåndsvisninger åbnet i et nyt vindue har ingen klikmål. ContentBlocks-felter markeres automatisk. Core-ressourcefelter og TVer skal markeres i din skabelon med snippet\'et mpField, for eksempel: [[!mpField? &name=`pagetitle`]] inde i det element, der viser feltet. Til og med version 1.7 blev Core-felter og TVer markeret automatisk, så efter en opgradering forbliver de umarkerede, indtil du tilføjer mpField. Se readme-filen for eksempler med ContentBlocks og Fenom. Standard: Nej.';
...
$_lang['magicpreview.draft_view'] = 'Vis';
$_lang['magicpreview.draft_share'] = 'Del';
...
$_lang['magicpreview.share_col_user'] = 'Delt af';
...
$_lang['magicpreview.share_col_expires_in'] = 'Tid tilbage';
$_lang['magicpreview.share_expired'] = 'Udløbet';
$_lang['magicpreview.share_time_minute'] = '1 minut';
$_lang['magicpreview.share_time_minutes'] = '[[+n]] minutter';
$_lang['magicpreview.share_time_hour'] = '1 time';
$_lang['magicpreview.share_time_hours'] = '[[+n]] timer';
$_lang['magicpreview.share_time_day'] = '1 dag';
$_lang['magicpreview.share_time_days'] = '[[+n]] dage';
