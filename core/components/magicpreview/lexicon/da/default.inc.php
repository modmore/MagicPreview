...
$_lang['setting_magicpreview.preview_mode_desc'] = 'Hvordan forhåndsvisningen vises. "newwindow" åbner et nyt browservindue (standard). "panel" viser et sidepanel i manageren.';
$_lang['setting_magicpreview.panel_layout'] = 'Panel-layout';
$_lang['setting_magicpreview.panel_layout_desc'] = 'Hvordan forhåndsvisningspanelet interagerer med editoren. "overlay" svæver ovenpå (standard). "onpage" formindsker editoren for en permanent kolonne.';
$_lang['setting_magicpreview.auto_preview'] = 'Automatisk forhåndsvisning';
$_lang['setting_magicpreview.auto_preview_desc'] = 'Generer automatisk en forhåndsvisning, når ressourceformularen indlæses. Gælder kun når forhåndsvisningstilstanden er sat til "panel". Standard: Nej.';
