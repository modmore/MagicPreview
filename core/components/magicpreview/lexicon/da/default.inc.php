...
$_lang['setting_magicpreview.click_to_field_desc'] = 'Eksperimentel. Når aktiveret, ruller et klik på et felt i forhåndsvisningen ressourceformularen til det pågældende felt og fremhæver det. ContentBlocks-felter markeres automatisk. Core-ressourcefelter og TVer skal markeres i din skabelon med snippet\'et mpField, for eksempel: [[mpField? &name=`pagetitle`]] inde i det element, der viser feltet. Ændret i 1.8.0: Core-felter og TVer blev tidligere markeret automatisk, så efter en opgradering forbliver de umarkerede, indtil du tilføjer mpField. Se readme-filen for eksempler med ContentBlocks og Fenom. Standard: Nej.';
