...
$_lang['setting_magicpreview.click_to_field_desc'] = 'Experimentell. Wenn aktiviert, scrollt ein Klick auf ein Feld in der Vorschau das Ressourcenformular zu diesem Feld und hebt es hervor. ContentBlocks-Felder werden automatisch markiert. Core-Ressourcenfelder und TVs müssen im Template mit dem Snippet mpField markiert werden, zum Beispiel: [[mpField? &name=`pagetitle`]] innerhalb des Elements, das das Feld ausgibt. Geändert in 1.8.0: Core-Felder und TVs wurden zuvor automatisch markiert, nach einem Upgrade bleiben sie daher unmarkiert, bis Sie mpField hinzufügen. Beispiele für ContentBlocks und Fenom finden Sie in der Readme-Datei. Standard: Nein.';
