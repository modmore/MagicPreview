...
$_lang['setting_magicpreview.click_to_field_desc'] = 'Experimentell. Wenn aktiviert, scrollt ein Klick auf ein Feld in der Vorschau das Ressourcenformular zu diesem Feld und hebt es hervor. Funktioniert am besten mit ContentBlocks, das die Ausgabe jedes Feldes automatisch umschließt. Es wird außerdem ein Best-Effort-Versuch unternommen, Core-Ressourcenfelder (pagetitle, longtitle, description, menutitle, introtext) und TVs über den Parser zu umschließen, was jedoch nicht alle Template-Ausgabekombinationen abdecken kann. Standard: Nein.';
