...
$_lang['setting_magicpreview.preview_mode_desc'] = 'Wie die Vorschau angezeigt wird. "newwindow" öffnet ein neues Browserfenster (Standard). "panel" zeigt ein Seitenpanel im Manager.';
$_lang['setting_magicpreview.panel_layout'] = 'Panel-Layout';
$_lang['setting_magicpreview.panel_layout_desc'] = 'Wie das Vorschau-Panel mit dem Editor interagiert. "overlay" schwebt darüber (Standard). "onpage" verkleinert den Editor für eine permanente Spalte.';
$_lang['setting_magicpreview.auto_preview'] = 'Automatische Vorschau';
$_lang['setting_magicpreview.auto_preview_desc'] = 'Automatisch eine Vorschau generieren, wenn das Ressourcen-Formular geladen wird. Gilt nur wenn der Vorschau-Modus auf "panel" eingestellt ist. Standard: Nein.';
