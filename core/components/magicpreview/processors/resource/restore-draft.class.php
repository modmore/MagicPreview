 ...
 * The client redirects with ?reload=<token> and MODX's native form
 * rendering pipeline restores all fields, TVs, and extras data.
 *
 * @package magicpreview
 */
class MagicPreviewRestoreDraftProcessor extends Processor
{
    use DraftTrait;
...
return 'MagicPreviewRestoreDraftProcessor';
